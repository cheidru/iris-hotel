...
export default function Home() {
  return (
    <main className="title">
      ...
      <h3 className="title-text">Уникальные условия для отдыха позволят тихо и уединенно отдохнуть каждой семье в своём отдельном коттедже или в апартаментах.</h3>
